...
describe('dashboardMockMetrics', () => {
  it('keeps 40-question mock stats separate from full-length mock stats', () => {
    const result = dashboardMockMetrics([
      {
        score: 5,
        exam: { questionCount: 40, questionsPerAttempt: null, timeLimitMinutes: 50 },
      },
      {
        score: 35,
        exam: { questionCount: 40, questionsPerAttempt: null, timeLimitMinutes: 50 },
      ...
      {
        score: 70,
        exam: { questionCount: 120, questionsPerAttempt: null, timeLimitMinutes: 120 },
      },
      {
        score: 80,
        exam: { questionCount: 120, questionsPerAttempt: null, timeLimitMinutes: 120 },
  ...
  it('excludes untimed, sampled, and other-size mocks from both dashboard sections', () => {
    const result = dashboardMockMetrics([
      {
        score: 90,
        exam: { questionCount: 40, questionsPerAttempt: null, timeLimitMinutes: 0 },
      },
      {
        score: 90,
        exam: { questionCount: 120, questionsPerAttempt: 10, timeLimitMinutes: 120 },
      },
      {
        score: 90,
        exam: { questionCount: 60, questionsPerAttempt: null, timeLimitMinutes: 60 },
      },
      {
        score: 90,
        exam: null,
